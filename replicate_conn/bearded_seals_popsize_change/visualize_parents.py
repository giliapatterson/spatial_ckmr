...
parser.add_argument("--R0", help = "R0")
parser.add_argument("--surv_mult", help = "survival multiplier")
parser.add_argument("--rep", help = "replicate number")
parser.add_argument("--bias", type = float, help = "bias")
parser.add_argument("--max_bias", type = float, help = "max bias")
parser.add_argument("--max_n", type = float, help = "max n")
...
parser.add_argument("sampling_out", help = "path to sampling plot")
parser.add_argument("intensity_out", help = "path to intensity plot")
parser.add_argument("metadata_out", help = "path to metadata file")
args = parser.parse_args()

R0 = args.R0
surv_mult = args.surv_mult
rep = args.rep
bias = args.bias
...
sampling_out = args.sampling_out
